...
async function createmsig(proposalName, actionstoSign, authorization,expires) {
  ...
  const msigData = {
    ...
    requested: [
      {actor: 'blazekos.vr', permission: 'active'},
      {actor: 'bonzmanifest', permission: 'active'},
      {actor: 'cypherbadger', permission: 'active'},
      {actor: 'dougweisberg', permission: 'active'},
      {actor: 'eoswatchdogs', permission: 'active'},
      {actor: 'floridaoneos', permission: 'active'},
      {actor: 'maxmaxmaxmac', permission: 'active'},
      {actor: 'petercheneos', permission: 'active'},
      {actor: 'raleighvigor', permission: 'active'},
      {actor: 'stablequan11', permission: 'active'}
    ],
    trx: {
      expiration,
      ref_block_num: 0,
