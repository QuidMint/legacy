...
#define VIGORLENDING eosio::name("vigorginseng")
#define VIGORSXZAP11 eosio::name("vigorsxzap11")
static constexpr name TOKEN_CONTRACT = "dummytokensx"_n;
#elif defined(LOCAL_MODE)
#define VIGORLENDING eosio::name("vigorlending")
#define VIGORSXZAP11 eosio::name("vigorsxzap11")
static constexpr name TOKEN_CONTRACT = "dummytokensx"_n;
#else
#define VIGORLENDING eosio::name("vigorlending")
#define VIGORSXZAP11 eosio::name("vigorsxzap11")
static constexpr name TOKEN_CONTRACT = "vigortokenlp"_n;
#endif
...
public:
    ...
    static constexpr name id = "vigorsxcurve"_n;
    static constexpr name code = "vigorsxcurve"_n;
